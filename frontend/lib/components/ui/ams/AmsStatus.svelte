        ...
        <div class="flex flex-none flex-col">
            ...
            <div class="relative flex gap-2 p-2">
                <div class="flex w-20 flex-col items-center">
                    <!-- spool ID row -->
                    <div class="text-md flex h-8 items-center text-slate-400"></div>
                    <!-- spool box -->
                    <div
                        class={cn(
                            "relative flex h-[120px] w-20 flex-col items-center justify-between rounded-lg p-3",
                            tailwindTextColorClass(formatColor(extSpool.color)),
                            tailwindFilamentBoxClass(extSpool),
                        )}
        ...
        <div class="flex-grow">
            ...
            <div class="relative flex gap-2 p-2">
                {#each slots as slot, index}
                    <div class="flex w-20 flex-col items-center">
                        ...
                        <div
                            class={cn(
                                "relative flex h-[120px] w-20 flex-col items-center justify-between rounded-lg p-3",
                                tailwindTextColorClass(formatColor(slot.color)),
                                tailwindFilamentBoxClass(slot),
                            )}
                ...
                <div class="flex w-20 flex-col items-center">
                    ...
                    <div
                        class="relative flex h-[120px] w-20 flex-col items-center justify-center overflow-hidden rounded-lg"
                    >
                        ...
                        <!-- Droplet icon -->
                        <Droplet class="z-10 h-8 w-8 text-slate-400" />
                    </div>
                </div>
            </div>
        </div>
